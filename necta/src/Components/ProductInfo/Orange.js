      ...
      <InfoContainer>
        <TextContainer>
          <TextSection>
            ...
            <SmallText>오렌지 추출액(생과일 오렌지 100%), 증류수</SmallText>
          </TextSection>
        </TextContainer>
        <Image bgUrl={require(`Components/assets/ProductInfo/product1.png`)} />
      </InfoContainer>
      <InfoContainer2>
        <Image
          bgUrl={require(`Components/assets/ProductInfo/product1_1.png`)}
        />
        <TextContainer>
          <TextSection>
            ...
            <InfoSection>
              ...
              <SectionContent>112 kcal</SectionContent>
            </InfoSection>
            <InfoSection>
              <SectionTitle>탄수화물</SectionTitle>
              <SectionContent>20 g</SectionContent>
            </InfoSection>
            <InfoSection>
              <SectionTitle>당류</SectionTitle>
              <SectionContent>15 g</SectionContent>
            </InfoSection>
            <InfoSection>
            ...
            <InfoSection>
              ...
              <SectionContent>6 g</SectionContent>
            </InfoSection>
            <InfoSection>

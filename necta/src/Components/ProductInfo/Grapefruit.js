...
const Grapefruit = () => {
  return (
    <Container>
      <PurchaseContainer>
        <Name>디톡스 자몽 500ml</Name>
        <RightContainer>
          <PriceContainer>
            <Price1>단품가 4,200원</Price1>
            <Price2>구독가 3,200원</Price2>
          </PriceContainer>
      ...
      <InfoContainer>
        <TextContainer>
          <TextSection>
            ...
            <SmallText>자몽 추출액(생과일 자몽 100%), 증류수</SmallText>
          </TextSection>
        </TextContainer>
        <Image bgUrl={require(`Components/assets/ProductInfo/product2.png`)} />
      </InfoContainer>
      <InfoContainer2>
        <Image
          bgUrl={require(`Components/assets/ProductInfo/product2_1.png`)}
        />
        <TextContainer>
          <TextSection>
            <InfoTitle>영양정보</InfoTitle>
            <InfoBlur>총 내용량당 영양성분(500ml)</InfoBlur>
            <InfoSection>
              <SectionTitle>열량</SectionTitle>
              <SectionContent>96 kcal</SectionContent>
            </InfoSection>
            <InfoSection>
              <SectionTitle>탄수화물</SectionTitle>
              <SectionContent>17 g</SectionContent>
            </InfoSection>
            <InfoSection>
              <SectionTitle>당류</SectionTitle>
              <SectionContent>13 g</SectionContent>
            </InfoSection>
            <InfoSection>
              <SectionTitle>지방</SectionTitle>
              <SectionContent>0.3 g</SectionContent>
            </InfoSection>
            <InfoSection>
              <SectionTitle>단백질</SectionTitle>
              <SectionContent>5 g</SectionContent>
            </InfoSection>
            <InfoSection>
            ...
            <InfoSection>
              ...
              <SectionContent>0.2 g</SectionContent>
            </InfoSection>
          </TextSection>
        </TextContainer>
      </InfoContainer2>
